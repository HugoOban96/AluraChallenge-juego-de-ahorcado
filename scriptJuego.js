;(function(){
    ...
    var palabras = ['ALURA','HTML','JAVASCRIPT','PROGRAMAR','ORACLE',''];
    ...
    var $html = {
      hombre: document.getElementById('canvas'),
      adivinado: document.querySelector('.letrasAcierto'),
      errado: document.querySelector('.letrasErrado')
    }
    ...
    function dibujar(juego) {
      ...
      for (let letra of palabra) {
        ...
        $span.setAttribute('class', 'letrasAcierto')
      ...
      for (let letra of errado) {
        ...
        $span.setAttribute('class', 'letrasErrada')
        $span.appendChild($txt)
        $elem.appendChild($span)
      }
    }
